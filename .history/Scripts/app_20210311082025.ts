...
namespace core
{
    ...
    {
      $(`#${router.ActiveLink}`).removeClass("active"); // removes highlighted link4router.ActiveLink = $(this).attr("id");
    ...
    /**
    * Function associates and returns a related callback to a route
    ...
    */
    ...
    /**
     * Entry point for our program (Same as the main)
     * @returns {void}
     */
    function Start(): void
    {
